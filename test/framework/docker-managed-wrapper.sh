...
export LOG_FILE="docker-managed.log"
...
#  cd "test/smoke" && make smoke-test
  ...
  print_style "#########################################\n" "info";
  tanzu diagnostics collect --workload-cluster-name ${guestclustername}
  tanzu diagnostics collect --management-cluster-name ${managedclustername}
